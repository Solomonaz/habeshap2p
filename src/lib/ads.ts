 ...
 */
const AD_COLUMNS =
  "id, user_id, side, rate_etb::text, min_etb::text, max_etb::text, payment_methods, payer_name, notes, receiving_name, receiving_number, receiving_note, receiving_accounts, status, created_at";
